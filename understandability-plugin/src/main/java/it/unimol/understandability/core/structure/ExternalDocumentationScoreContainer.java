...
public class ExternalDocumentationScoreContainer {
    ...
    private static Map<Project, ExternalDocumentationScoreContainer> instances = new HashMap<>();
    ...
    private Map<String, Double> externalScoreCache;

    private Map<String, Double> documentationScore;
    private Map<String, Double> normalizedDocumentationScore;

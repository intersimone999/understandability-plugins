...
public class SelectSnippetsTask extends MyTask {
    ...
    private static final Map<String, Integer> classToId;

    private static int methodId;
    private static final Map<String, Integer> methodToId;
    ...
    private final List<String> allSnippetsSignatures;
    private final Set<String> alreadyAddedClasses;
...
//                    System.out.println(methodSignature);
    ...
    class Visitor extends PsiRecursiveElementVisitor {
        private final Queue<TempPsiClass> toAnalyze;

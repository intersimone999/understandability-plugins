...
import it.unimol.understandability.ui.tasks.OpenStartingClassesTask;
import it.unimol.understandability.ui.tasks.TaskChain;

/**
 * Created by simone on 07/12/16.
 */
public class OpenStartingClassesAction extends AnAction {
    private static final Logger LOG = Logger.getInstance(OpenStartingClassesAction.class);
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        taskChain.appendTask(new OpenStartingClassesTask(e.getProject(), file));

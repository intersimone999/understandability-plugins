 ...
 */
public class OpenCentralClassesTask extends MyTask {
    public OpenCentralClassesTask(Project project) {
        this(project, project.getBaseDir());
    }

    public OpenCentralClassesTask(Project project, VirtualFile root) {
...
//            Set<PsiElement> topElements = discoverer.discover(10);
            List<PsiElement> topElements = discoverer.getCentralPoints(10);
